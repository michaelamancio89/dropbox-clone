class DropBoxController{
    ...
    connectFirebase(){
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyDSg_btV1AMsQElCE-27tHEAsCV-ABzIPk",
            authDomain: "dropbox-clone-30690.firebaseapp.com",
            databaseURL: "https://dropbox-clone-30690.firebaseio.com",
            projectId: "dropbox-clone-30690",
            storageBucket: "dropbox-clone-30690.appspot.com",
            messagingSenderId: "782227194293",
            appId: "1:782227194293:web:28cda45cff4df6e625d9fc",
            measurementId: "G-0WZN33WPHY"
        };
        // Initialize Firebase
    ...
    removeTask(){
        ...
        this.getSelection().forEach(li=>{
            ...
            let file = JSON.parse(li.data.file);
